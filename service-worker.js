const CACHE_NAME = "zhunaer-app-shell-v7";
const APP_SHELL = [
  "./",
  "./index.html",
  ...
  "./src/ui/router.mjs",
  "./src/ui/task-center.mjs",
  "./src/ui/match-detail.mjs",
  "./assets/app-icon.svg",
  "./assets/bear-agent-avatar.webp",
  "./assets/bear/body.webp",
  "./assets/bear/head.webp",
  "./assets/bear/hat.webp",
  "./assets/bear/arm-left.webp",
  "./assets/bear/arm-right.webp",
  "./assets/bear/eyes-closed.webp",

...
function renterClarify() {
  ...
  return `<section class="flow-screen">
    ...
    <div class="rental-chat">
      ...
      <div class="chat-line is-agent is-form"><span class="chat-avatar"><img src="./assets/bear-agent-avatar.webp" width="36" height="41" alt="" loading="lazy" decoding="async" /></span><div class="chat-bubble is-summary"><b>我先整理成这样</b><div class="chat-tags">${tags.map((tag) => `<span>${escapeHtml(tag)}</span>`).join("") || "<span>等你补充</span>"}</div></div></div>
...
function supplyDraftScreen() {
  ...
  return `<section class="flow-screen">
    ...
    <div class="rental-chat supply-chat">
      ...
      <div class="chat-line is-agent is-form"><span class="chat-avatar"><img src="./assets/bear-agent-avatar.webp" width="36" height="41" alt="" loading="lazy" decoding="async" /></span><div class="chat-bubble is-summary"><b>我先整理成这样</b><div class="chat-tags">${tags.map((tag) => `<span>${escapeHtml(tag)}</span>`).join("")}</div></div></div>
